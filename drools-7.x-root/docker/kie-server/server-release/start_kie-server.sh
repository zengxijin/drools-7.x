...
# If this KIE execution server container is linked with some KIE Workbench container,
# the following environemnt variables will be present, so configure the application arguments based on their values.
